...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-10 animate-fade-in-up">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold" style="color:#F59E0B;">Criar Anúncio</h1>
        <p class="text-sm mt-1" style="color:#9CA3AF;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.</p>
    </div>
    ...
    <form method="POST" action="{{ route('announcements.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-section">
            ...
            <div class="flex items-center gap-4">
                <div id="imgPreview" class="w-16 h-16 rounded-full overflow-hidden flex items-center justify-center" style="background:#2a2a2a;border:2px solid #333;">
        ...
        <div class="form-section">
            ...
            <input type="text" name="title" value="{{ old('title') }}" class="input-subtle" required>
        ...
        <div class="form-section">
            ...
            <div>
                <textarea name="description" id="descTextarea" rows="7" maxlength="500"
                    ...
                    class="input-subtle resize-none w-full">{{ old('description') }}</textarea>
                <p class="text-xs mt-1" style="color:#9CA3AF;"><span id="descCount">0</span> characters left</p>
            </div>
        ...
        <div class="form-section">
            ...
            <input type="date" name="event_date" value="{{ old('event_date') }}" class="input-subtle" style="max-width:300px;" min="{{ date('Y-m-d H:i:s') }}">
        ...
        <div class="form-section">
            ...
            <div class="space-y-3">
                <input type="number" name="price" value="{{ old('price') }}" placeholder="R$0000" step="0.01" min="0" class="input-subtle">
                <input type="text" name="location" value="{{ old('location') }}" placeholder="Av. Nome do Local, 546" class="input-subtle">
            </div>
            @error('price')<p class="text-red-400 text-xs mt-1">{{ $message }}</p>@enderror
        </div>

        <div class="flex justify-end gap-3 mt-6 pt-4" style="border-top:1px solid #2a2a2a;">
            <a href="{{ route('announcements.index') }}" class="btn-outline">Cancelar</a>
