        ...
        <article class="card-announcement animate-fade-in-up" style="animation-delay: {{ $loop->iteration * 0.05 }}s;">
            ...
            <div class="p-4">
                ...
                <p class="text-xs mb-1" style="color:#9CA3AF;">
                    <svg class="w-3 h-3 inline-block" style="vertical-align:-1px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    {{ $ad->getFormattedEventDate() }}
                </p>
                @endif
